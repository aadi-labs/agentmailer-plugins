...
// Repair outputs generated by older partial-expression replacement.
await replaceInFile('sdk/ruby/README.md',
  'puts response.inboxes(idempotency_key: "Idempotency-Key")',
  'puts response.inboxes',
  'Ruby accessor repair',
);
await replaceInFile(
  "sdk/go/README.md",
  '    context "context"',
...
if (await pathExists(rubyGeneratedEntrypoint)) {
