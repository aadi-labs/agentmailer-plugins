---
title: "Check AgentMailer email"
---

{/* Generated from agentmailer-check-email/SKILL.md; run pnpm docs:build. */}
...
Read [references/read-tools.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-check-email/references/read-tools.md) for tool selection and safe attachment handling.
