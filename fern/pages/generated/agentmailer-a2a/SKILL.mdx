---
title: "AgentMailer agent communication"
---

{/* Generated from agentmailer-a2a/SKILL.md; run pnpm docs:build. */}
...
Read [references/a2a-tools.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-a2a/references/a2a-tools.md) for the tool map, task states, admission model, and retry invariants.
