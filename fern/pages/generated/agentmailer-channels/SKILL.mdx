---
title: "AgentMailer human communication channels"
---

{/* Generated from agentmailer-channels/SKILL.md; run pnpm docs:build. */}
...
Read [references/channels.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-channels/references/channels.md) for the tool map, supported payloads, lifecycle states, and retry invariants.
