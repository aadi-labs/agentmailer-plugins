---
title: "AgentMailer toolkit"
---

{/* Generated from agentmailer-toolkit/SKILL.md; run pnpm docs:build. */}
...
Read [references/frameworks.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-toolkit/references/frameworks.md) for framework-neutral adapter boundaries.
