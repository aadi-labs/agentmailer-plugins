---
title: "AgentMailer security"
---

{/* Generated from agentmailer-security/SKILL.md; run pnpm docs:build. */}
...
For implementation or audit work, read [references/threat-model.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-security/references/threat-model.md). For action authorization, read [references/authorization.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-security/references/authorization.md).
