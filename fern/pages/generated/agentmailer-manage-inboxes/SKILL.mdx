---
title: "AgentMailer Inbox"
---

{/* Generated from agentmailer-manage-inboxes/SKILL.md; run pnpm docs:build. */}
...
Read [references/inbox-tools.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-manage-inboxes/references/inbox-tools.md) when choosing tool inputs or handling permissions.
