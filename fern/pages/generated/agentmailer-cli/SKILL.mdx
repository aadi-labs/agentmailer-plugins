---
title: "AgentMailer CLI"
---

{/* Generated from agentmailer-cli/SKILL.md; run pnpm docs:build. */}
...
Read [references/commands.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-cli/references/commands.md) for global controls and operational patterns.
