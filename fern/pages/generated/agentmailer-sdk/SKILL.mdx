---
title: "AgentMailer SDK"
---

{/* Generated from agentmailer-sdk/SKILL.md; run pnpm docs:build. */}
...
Read [references/languages.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-sdk/references/languages.md) for language entry points and maintained helpers.
