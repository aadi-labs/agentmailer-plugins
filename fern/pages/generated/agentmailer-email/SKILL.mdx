---
title: "AgentMailer email router"
---

{/* Generated from agentmailer-email/SKILL.md; run pnpm docs:build. */}
...
The legacy [email tool reference](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-email/references/email-tools.md) remains available for installations that have not yet adopted the focused skills.
