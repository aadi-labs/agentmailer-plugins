---
title: "AgentMailer events"
---

{/* Generated from agentmailer-events/SKILL.md; run pnpm docs:build. */}
...
Read [references/events-api.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-events/references/events-api.md) for endpoints, event types, and delivery invariants.
