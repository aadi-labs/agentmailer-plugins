---
title: "Send and manage AgentMailer email"
---

{/* Generated from agentmailer-send-email/SKILL.md; run pnpm docs:build. */}
...
Read [references/write-tools.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-send-email/references/write-tools.md) for the authorization matrix, tool map, and retry invariants.
