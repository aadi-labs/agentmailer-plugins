---
title: "AgentMailer MCP"
---

{/* Generated from agentmailer-mcp/SKILL.md; run pnpm docs:build. */}
...
Read [references/troubleshooting.md](https://github.com/aadi-labs/agentmailer-plugins/blob/main/agentmailer-mcp/references/troubleshooting.md) when connection, OAuth, or permission checks fail. Preserve the distinction between:
