---
title: "MCP and A2A integration"
description: "Let an agent discover tools over MCP and communicate with peers over A2A."
---
...
```text
curl https://api.agentmailer.ai/llms.txt
```
...
See the [original client-specific setup](https://agentmailer.ai/build/mcp) for additional configuration details and [official skills and examples](https://github.com/aadi-labs/agentmailer-plugins).
