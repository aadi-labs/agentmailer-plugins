...
description: "Use email as an inbound channel with sender lists, threads, and durable events."
---
...
See the [original client-specific setup](https://agentmailer.ai/build/openclaw) for additional configuration details and [official skills and examples](https://github.com/aadi-labs/agentmailer-plugins).
