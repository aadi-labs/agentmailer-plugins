...
description: "Add AgentMailer as an Eve MCP connection and give a durable agent an equally durable identity."
---
...
See the [original client-specific setup](https://agentmailer.ai/build/eve) for additional configuration details and [official skills and examples](https://github.com/aadi-labs/agentmailer-plugins).
