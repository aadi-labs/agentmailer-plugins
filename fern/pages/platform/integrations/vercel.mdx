...
description: "Provision identities from a Next.js application and stream events to your agents."
---
...
```text
curl https://api.agentmailer.ai/openapi.json
```
...
See the [original client-specific setup](https://agentmailer.ai/build/vercel) for additional configuration details and [official skills and examples](https://github.com/aadi-labs/agentmailer-plugins).
