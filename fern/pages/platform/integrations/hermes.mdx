...
description: "Connect Hermes through remote MCP so it can claim an identity and operate a two-way inbox."
---
...
See the [original client-specific setup](https://agentmailer.ai/build/hermes) for additional configuration details and [official skills and examples](https://github.com/aadi-labs/agentmailer-plugins).
