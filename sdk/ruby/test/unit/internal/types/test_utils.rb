...
describe AgentMailer::Internal::Types::Utils do
  Utils = AgentMailer::Internal::Types::Utils

  module TestUtils
    class M < AgentMailer::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < AgentMailer::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < AgentMailer::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = AgentMailer::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { AgentMailer::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = AgentMailer::Internal::Types::Array[String]
      ModelArray = -> { AgentMailer::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { AgentMailer::Internal::Types::Array[TestUtils::U] }
