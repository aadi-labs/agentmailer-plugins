...
describe AgentMailer::Internal::Types::Union do
  class Rectangle < AgentMailer::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < AgentMailer::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < AgentMailer::Internal::Types::Model
