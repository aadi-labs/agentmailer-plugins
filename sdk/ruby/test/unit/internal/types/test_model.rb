...
describe AgentMailer::Internal::Types::Model do
  ...
  class ExampleModel < AgentMailer::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < AgentMailer::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < AgentMailer::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < AgentMailer::Internal::Types::Model
