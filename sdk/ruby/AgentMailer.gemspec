...
require_relative "lib/AgentMailer/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["AgentMailer"]
  spec.version = AgentMailer::VERSION
  spec.summary = "Ruby client library for the AgentMailer API"
  spec.description = "The AgentMailer Ruby library provides convenient access to the AgentMailer API from Ruby."
