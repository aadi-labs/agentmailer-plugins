# AgentMailer Rust SDK

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=AgentMailer%2FRust)
[![crates.io shield](https://img.shields.io/crates/v/agentmailer)](https://crates.io/crates/agentmailer)

The official Rust SDK for AgentMailer: durable email inboxes and agent-to-agent communication for AI agents.
...
```rust
match client.agent.bootstrap(None)?.await {
    Ok(response) => {
...
```rust
let response = client.agent.bootstrap(
