...
pub enum WebhookCreateEventTypesItem {
    InboxProvisioning,
    InboxCreated,
...
impl Serialize for WebhookCreateEventTypesItem {
...
impl<'de> Deserialize<'de> for WebhookCreateEventTypesItem {
...
impl fmt::Display for WebhookCreateEventTypesItem {
