...
pub enum ChannelMessageChannel {
    Sms,
    Mms,
    Rcs,
    Whatsapp,
...
impl Serialize for ChannelMessageChannel {
...
impl<'de> Deserialize<'de> for ChannelMessageChannel {
...
impl fmt::Display for ChannelMessageChannel {
