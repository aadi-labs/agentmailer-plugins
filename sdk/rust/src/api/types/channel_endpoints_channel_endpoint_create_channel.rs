...
pub enum ChannelEndpointCreateChannel {
    Sms,
    Mms,
    Rcs,
    Whatsapp,
...
impl Serialize for ChannelEndpointCreateChannel {
...
impl<'de> Deserialize<'de> for ChannelEndpointCreateChannel {
...
impl fmt::Display for ChannelEndpointCreateChannel {
