...
pub enum ListChannelMessagesRequestChannel {
    Sms,
    Mms,
    Rcs,
    Whatsapp,
...
impl Serialize for ListChannelMessagesRequestChannel {
...
impl<'de> Deserialize<'de> for ListChannelMessagesRequestChannel {
...
impl fmt::Display for ListChannelMessagesRequestChannel {
