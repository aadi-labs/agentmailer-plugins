...
pub enum ChannelRecipientPermissionStatus {
    Consented,
    OptedOut,
...
impl Serialize for ChannelRecipientPermissionStatus {
...
impl<'de> Deserialize<'de> for ChannelRecipientPermissionStatus {
...
impl fmt::Display for ChannelRecipientPermissionStatus {
