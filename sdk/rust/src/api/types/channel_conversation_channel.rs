...
pub enum ChannelConversationChannel {
    Sms,
    Mms,
    Rcs,
    Whatsapp,
...
impl Serialize for ChannelConversationChannel {
...
impl<'de> Deserialize<'de> for ChannelConversationChannel {
...
impl fmt::Display for ChannelConversationChannel {
