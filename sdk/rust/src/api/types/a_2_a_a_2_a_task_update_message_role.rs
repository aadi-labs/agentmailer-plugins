...
pub enum A2ATaskUpdateMessageRole {
    RoleUser,
    RoleAgent,
...
impl Serialize for A2ATaskUpdateMessageRole {
...
impl<'de> Deserialize<'de> for A2ATaskUpdateMessageRole {
...
impl fmt::Display for A2ATaskUpdateMessageRole {
