...
pub enum ChannelEndpointCapabilitiesItem {
    Sms,
    Mms,
    Rcs,
    Whatsapp,
...
impl Serialize for ChannelEndpointCapabilitiesItem {
...
impl<'de> Deserialize<'de> for ChannelEndpointCapabilitiesItem {
...
impl fmt::Display for ChannelEndpointCapabilitiesItem {
