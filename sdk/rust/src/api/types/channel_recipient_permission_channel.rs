...
pub enum ChannelRecipientPermissionChannel {
    Sms,
    Mms,
    Rcs,
    Whatsapp,
...
impl Serialize for ChannelRecipientPermissionChannel {
...
impl<'de> Deserialize<'de> for ChannelRecipientPermissionChannel {
...
impl fmt::Display for ChannelRecipientPermissionChannel {
