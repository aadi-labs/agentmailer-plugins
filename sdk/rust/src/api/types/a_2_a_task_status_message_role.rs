...
pub enum A2ATaskStatusMessageRole {
    RoleUser,
    RoleAgent,
...
impl Serialize for A2ATaskStatusMessageRole {
...
impl<'de> Deserialize<'de> for A2ATaskStatusMessageRole {
...
impl fmt::Display for A2ATaskStatusMessageRole {
