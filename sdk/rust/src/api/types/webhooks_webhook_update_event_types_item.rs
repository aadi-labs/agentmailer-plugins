...
pub enum WebhookUpdateEventTypesItem {
    InboxProvisioning,
    InboxCreated,
...
impl Serialize for WebhookUpdateEventTypesItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        match self {
            ...
            Self::ChannelEndpointCreated => serializer.serialize_str("channel.endpoint.created"),
            Self::ChannelMessageReceived => serializer.serialize_str("channel.message.received"),
            Self::ChannelMessageBlocked => serializer.serialize_str("channel.message.blocked"),
            Self::ChannelMessageSendRequested => {
                serializer.serialize_str("channel.message.send.requested")
            }
            Self::ChannelMessageSent => serializer.serialize_str("channel.message.sent"),
            Self::ChannelMessageDelivered => serializer.serialize_str("channel.message.delivered"),
            Self::ChannelMessageRead => serializer.serialize_str("channel.message.read"),
            Self::ChannelMessageFailed => serializer.serialize_str("channel.message.failed"),
...
impl<'de> Deserialize<'de> for WebhookUpdateEventTypesItem {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        match value.as_str() {
            ...
            "channel.endpoint.created" => Ok(Self::ChannelEndpointCreated),
            "channel.message.received" => Ok(Self::ChannelMessageReceived),
            "channel.message.blocked" => Ok(Self::ChannelMessageBlocked),
            "channel.message.send.requested" => Ok(Self::ChannelMessageSendRequested),
            "channel.message.sent" => Ok(Self::ChannelMessageSent),
            "channel.message.delivered" => Ok(Self::ChannelMessageDelivered),
            "channel.message.read" => Ok(Self::ChannelMessageRead),
            "channel.message.failed" => Ok(Self::ChannelMessageFailed),
...
impl fmt::Display for WebhookUpdateEventTypesItem {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::ChannelEndpointCreated => write!(f, "channel.endpoint.created"),
            Self::ChannelMessageReceived => write!(f, "channel.message.received"),
            Self::ChannelMessageBlocked => write!(f, "channel.message.blocked"),
            Self::ChannelMessageSendRequested => write!(f, "channel.message.send.requested"),
            Self::ChannelMessageSent => write!(f, "channel.message.sent"),
            Self::ChannelMessageDelivered => write!(f, "channel.message.delivered"),
            Self::ChannelMessageRead => write!(f, "channel.message.read"),
            Self::ChannelMessageFailed => write!(f, "channel.message.failed"),
