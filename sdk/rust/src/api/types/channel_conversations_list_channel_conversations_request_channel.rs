...
pub enum ListChannelConversationsRequestChannel {
    Sms,
    Mms,
    Rcs,
    Whatsapp,
...
impl Serialize for ListChannelConversationsRequestChannel {
...
impl<'de> Deserialize<'de> for ListChannelConversationsRequestChannel {
...
impl fmt::Display for ListChannelConversationsRequestChannel {
