...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw AgentMailerError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw AgentMailerError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: AgentMailerError?
                ...
                } else if let existingClientError = error as? AgentMailerError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw AgentMailerError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> AgentMailerError
    {
        ...
        return AgentMailerError.httpError(httpError)
    }
}
