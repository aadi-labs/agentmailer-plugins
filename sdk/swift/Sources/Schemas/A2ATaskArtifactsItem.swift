...
public struct A2ATaskArtifactsItem: Codable, Hashable, Sendable {
    public let artifactId: String
    public let name: String?
    public let description: String?
    public let parts: [A2ATaskArtifactsItemPartsItem]
    ...
    public init(
        ...
        parts: [A2ATaskArtifactsItemPartsItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.parts = try container.decode([A2ATaskArtifactsItemPartsItem].self, forKey: .parts)
