...
public struct A2ATaskHistoryItem: Codable, Hashable, Sendable {
    public let messageId: String
    public let contextId: String?
    public let taskId: String?
    public let role: A2ATaskHistoryItemRole
    public let parts: [A2ATaskHistoryItemPartsItem]
    ...
    public init(
        ...
        parts: [A2ATaskHistoryItemPartsItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.role = try container.decode(A2ATaskHistoryItemRole.self, forKey: .role)
        self.parts = try container.decode([A2ATaskHistoryItemPartsItem].self, forKey: .parts)
