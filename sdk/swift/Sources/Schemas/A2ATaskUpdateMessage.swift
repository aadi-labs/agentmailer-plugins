...
public struct A2ATaskUpdateMessage: Codable, Hashable, Sendable {
    public let messageId: String
    public let contextId: String?
    public let taskId: String?
    public let role: A2ATaskUpdateMessageRole
    public let parts: [A2ATaskUpdateMessagePartsItem]
    ...
    public init(
        ...
        parts: [A2ATaskUpdateMessagePartsItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.role = try container.decode(A2ATaskUpdateMessageRole.self, forKey: .role)
        self.parts = try container.decode([A2ATaskUpdateMessagePartsItem].self, forKey: .parts)
