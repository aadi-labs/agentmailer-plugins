...
from agentmailer.client import AgentMailer

# Check once at import time whether the client constructor accepts a headers kwarg.
try:
    _CLIENT_SUPPORTS_HEADERS: bool = "headers" in inspect.signature(AgentMailer).parameters
...
def get_client(test_id: str) -> AgentMailer:
    """
