...
export type BaseClientOptions = {
    environment?: core.Supplier<environments.AgentMailerEnvironment | string>;
...
export function normalizeClientOptions<T extends BaseClientOptions = BaseClientOptions>(
    ...
    const headers = mergeHeaders(
        { "X-Fern-Language": "JavaScript", "X-Fern-SDK-Name": "@agentmailer/sdk", "X-Fern-SDK-Version": "0.1.0", "User-Agent": "@agentmailer/sdk/0.1.0", "X-Fern-Runtime": core.RUNTIME.type, "X-Fern-Runtime-Version": core.RUNTIME.version },
        options?.headers
    );
