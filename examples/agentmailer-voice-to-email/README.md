...
Turn a supplied transcript into a reviewable email draft.
...
```sh
pnpm --filter @agentmailer/example-voice-to-email start
```

## Python

```sh
cd examples/agentmailer-voice-to-email/python
