...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"voice-to-email","title":"Voice-to-email","summary":"Turn a supplied transcript into a reviewable email draft.","mode":"outbound","keywords":["transcript","recipient","subject","intent"]};
