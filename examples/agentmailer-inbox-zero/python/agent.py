...
CONFIG = {"slug":"inbox-zero","title":"Inbox Zero agent","summary":"Classify mail, draft replies, and produce an actionable digest.","mode":"digest","keywords":["urgent","reply","action","waiting","archive"]}
