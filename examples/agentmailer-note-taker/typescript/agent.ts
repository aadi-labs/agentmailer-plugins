...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"note-taker","title":"Email note taker","summary":"Convert forwarded email into structured Markdown notes.","mode":"extract","keywords":["note","decision","action","owner","deadline"]};
