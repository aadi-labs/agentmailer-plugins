...
CONFIG = {"slug":"dinner-agent","title":"Dinner coordination agent","summary":"Coordinate participants, cuisine preferences, constraints, and a final dinner plan.","mode":"reply","keywords":["participants","cuisine","allergies","location","availability"]}
