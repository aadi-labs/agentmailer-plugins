...
CONFIG = {"slug":"x402-payment-agent","title":"x402 payment agent","summary":"Validate invoice intent and prepare a payment approval record.","mode":"action","keywords":["payment","invoice","vendor","amount","wallet"]}
