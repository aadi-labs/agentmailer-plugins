...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"github-maintainer-agent","title":"GitHub maintainer agent","summary":"Convert repository notifications into proposed maintainer actions.","mode":"action","keywords":["issue","pull","request","review","failing","test"]};
