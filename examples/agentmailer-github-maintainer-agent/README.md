...
Convert repository notifications into proposed maintainer actions.
...
effects behind an explicit opt-in. EXECUTE_ACTION_EXAMPLE=1 emits an approved action to your configured webhook.
...
```sh
pnpm --filter @agentmailer/example-github-maintainer-agent start
```

## Python

```sh
cd examples/agentmailer-github-maintainer-agent/python
