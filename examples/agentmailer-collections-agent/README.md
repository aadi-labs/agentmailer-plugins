...
Draft respectful, policy-bounded payment reminders.
...
```sh
pnpm --filter @agentmailer/example-collections-agent start
```

## Python

```sh
cd examples/agentmailer-collections-agent/python
