...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"collections-agent","title":"Collections agent","summary":"Draft respectful, policy-bounded payment reminders.","mode":"outbound","keywords":["invoice","overdue","reminder","balance","due"]};
