...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"gtm-agent","title":"GTM outreach agent","summary":"Research a prospect and draft relevant, permission-aware outreach.","mode":"outbound","keywords":["prospect","company","role","pain","relevance"]};
