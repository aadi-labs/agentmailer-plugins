...
Research a prospect and draft relevant, permission-aware outreach.
...
```sh
pnpm --filter @agentmailer/example-gtm-agent start
```

## Python

```sh
cd examples/agentmailer-gtm-agent/python
