...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"invoice-processor","title":"Invoice processor","summary":"Extract invoice fields and route exceptions for review.","mode":"extract","keywords":["invoice","total","due","vendor","purchase","order"]};
