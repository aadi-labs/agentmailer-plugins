...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"dinner-reservation","title":"Dinner reservation agent","summary":"Coordinate availability and prepare restaurant reservation replies.","mode":"reply","keywords":["reservation","dinner","restaurant","availability","party"]};
