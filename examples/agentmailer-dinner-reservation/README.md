...
Coordinate availability and prepare restaurant reservation replies.
...
```sh
pnpm --filter @agentmailer/example-dinner-reservation start
```

## Python

```sh
cd examples/agentmailer-dinner-reservation/python
