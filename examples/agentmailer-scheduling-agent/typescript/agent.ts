...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"scheduling-agent","title":"Scheduling agent","summary":"Propose meeting times and preserve timezone context.","mode":"reply","keywords":["meeting","schedule","availability","timezone","calendar"]};
