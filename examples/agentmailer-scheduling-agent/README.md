...
Propose meeting times and preserve timezone context.
...
```sh
pnpm --filter @agentmailer/example-scheduling-agent start
```

## Python

```sh
cd examples/agentmailer-scheduling-agent/python
