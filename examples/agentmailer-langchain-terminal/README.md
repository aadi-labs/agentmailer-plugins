...
Use AgentMailer as the mailbox behind an interactive agent loop.
...
```sh
pnpm --filter @agentmailer/example-langchain-terminal start
```

## Python

```sh
cd examples/agentmailer-langchain-terminal/python
