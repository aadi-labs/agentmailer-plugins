...
CONFIG = {"slug":"langchain-terminal","title":"LangChain terminal","summary":"Use AgentMailer as the mailbox behind an interactive agent loop.","mode":"terminal","keywords":["mailbox","search","summarize","draft"]}
