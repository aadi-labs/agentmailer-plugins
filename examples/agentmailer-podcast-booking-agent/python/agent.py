...
CONFIG = {"slug":"podcast-booking-agent","title":"Podcast booking agent","summary":"Research fit and draft guest booking outreach.","mode":"outbound","keywords":["podcast","audience","topic","guest","availability"]}
