...
CONFIG = {"slug":"hiring-screener-agent","title":"Hiring screener","summary":"Structure applicant evidence against an explicit rubric.","mode":"extract","keywords":["candidate","experience","role","portfolio","availability"]}
