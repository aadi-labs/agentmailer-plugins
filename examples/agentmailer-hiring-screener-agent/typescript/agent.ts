...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"hiring-screener-agent","title":"Hiring screener","summary":"Structure applicant evidence against an explicit rubric.","mode":"extract","keywords":["candidate","experience","role","portfolio","availability"]};
