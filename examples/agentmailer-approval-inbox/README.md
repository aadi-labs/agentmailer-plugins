...
Turn inbound requests into explicit approve or reject drafts.
...
```sh
pnpm --filter @agentmailer/example-approval-inbox start
```

## Python

```sh
cd examples/agentmailer-approval-inbox/python
