...
CONFIG = {"slug":"approval-inbox","title":"Approval inbox","summary":"Turn inbound requests into explicit approve or reject drafts.","mode":"reply","keywords":["approval","request","risk","scope","owner"]}
