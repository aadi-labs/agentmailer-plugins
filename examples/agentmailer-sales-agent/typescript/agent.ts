...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"sales-agent","title":"Sales agent","summary":"Qualify inbound interest and draft the next useful response.","mode":"reply","keywords":["company","need","timeline","budget","decision"]};
