...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"cold-email-researcher","title":"Cold email researcher","summary":"Turn supplied prospect context into relevant opt-out-friendly outreach.","mode":"outbound","keywords":["prospect","trigger","relevance","evidence","opt","out"]};
