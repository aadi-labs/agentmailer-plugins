...
CONFIG = {"slug":"cold-email-researcher","title":"Cold email researcher","summary":"Turn supplied prospect context into relevant opt-out-friendly outreach.","mode":"outbound","keywords":["prospect","trigger","relevance","evidence","opt","out"]}
