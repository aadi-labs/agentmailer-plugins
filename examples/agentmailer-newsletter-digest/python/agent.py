...
CONFIG = {"slug":"newsletter-digest","title":"Newsletter digest","summary":"Summarize newsletters into one concise briefing.","mode":"digest","keywords":["newsletter","update","launch","research","read"]}
