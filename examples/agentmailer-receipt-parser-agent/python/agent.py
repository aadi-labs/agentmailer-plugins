...
CONFIG = {"slug":"receipt-parser-agent","title":"Receipt parser","summary":"Extract merchant, date, tax, total, and currency fields.","mode":"extract","keywords":["receipt","merchant","tax","total","currency"]}
