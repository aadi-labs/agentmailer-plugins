...
Use an OpenAI-compatible model to inspect and reason about mail.
...
```sh
pnpm --filter @agentmailer/example-openai-terminal start
```

## Python

```sh
cd examples/agentmailer-openai-terminal/python
