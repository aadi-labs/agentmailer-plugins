...
CONFIG = {"slug":"openai-terminal","title":"OpenAI terminal","summary":"Use an OpenAI-compatible model to inspect and reason about mail.","mode":"terminal","keywords":["mailbox","search","summarize","draft"]}
