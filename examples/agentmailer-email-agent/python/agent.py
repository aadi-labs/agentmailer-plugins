...
CONFIG = {"slug":"email-agent","title":"Autonomous email agent","summary":"Draft a safe response to inbound mail with an explicit send boundary.","mode":"reply","keywords":["request","question","context","next","step"]}
