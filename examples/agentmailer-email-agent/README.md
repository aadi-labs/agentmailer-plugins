...
Draft a safe response to inbound mail with an explicit send boundary.
...
```sh
pnpm --filter @agentmailer/example-email-agent start
```

## Python

```sh
cd examples/agentmailer-email-agent/python
