...
CONFIG = {"slug":"docs-assistant","title":"Documentation assistant","summary":"Answer product questions with cited documentation links.","mode":"reply","keywords":["documentation","docs","how","setup","error"]}
