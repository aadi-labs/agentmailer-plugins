...
CONFIG = {"slug":"contract-redline-agent","title":"Contract redline agent","summary":"Identify risky clauses and propose review notes.","mode":"extract","keywords":["contract","liability","indemnity","termination","renewal"]}
