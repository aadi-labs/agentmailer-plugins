...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"contract-redline-agent","title":"Contract redline agent","summary":"Identify risky clauses and propose review notes.","mode":"extract","keywords":["contract","liability","indemnity","termination","renewal"]};
