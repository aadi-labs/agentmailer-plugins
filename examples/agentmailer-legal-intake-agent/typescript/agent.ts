...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"legal-intake-agent","title":"Legal intake agent","summary":"Collect conflict-check and matter-intake facts without legal advice.","mode":"reply","keywords":["matter","parties","jurisdiction","deadline","conflict"]};
