...
Collect conflict-check and matter-intake facts without legal advice.
...
```sh
pnpm --filter @agentmailer/example-legal-intake-agent start
```

## Python

```sh
cd examples/agentmailer-legal-intake-agent/python
