...
CONFIG = {"slug":"browser-signup-agent","title":"Browser signup agent","summary":"Coordinate signup verification emails without exposing one-time codes.","mode":"action","keywords":["verify","verification","code","signup","account"]}
