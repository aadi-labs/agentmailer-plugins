...
Coordinate signup verification emails without exposing one-time codes.
...
```sh
pnpm --filter @agentmailer/example-browser-signup-agent start
```

## Python

```sh
cd examples/agentmailer-browser-signup-agent/python
