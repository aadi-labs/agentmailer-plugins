...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"browser-signup-agent","title":"Browser signup agent","summary":"Coordinate signup verification emails without exposing one-time codes.","mode":"action","keywords":["verify","verification","code","signup","account"]};
