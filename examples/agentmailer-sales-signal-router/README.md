...
Classify buying signals and route the next action.
...
```sh
pnpm --filter @agentmailer/example-sales-signal-router start
```

## Python

```sh
cd examples/agentmailer-sales-signal-router/python
