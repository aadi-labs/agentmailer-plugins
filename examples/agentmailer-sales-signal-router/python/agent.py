...
CONFIG = {"slug":"sales-signal-router","title":"Sales signal router","summary":"Classify buying signals and route the next action.","mode":"extract","keywords":["pricing","demo","security","procurement","timeline"]}
