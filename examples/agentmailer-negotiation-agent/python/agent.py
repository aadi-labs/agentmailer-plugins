...
CONFIG = {"slug":"negotiation-agent","title":"Negotiation agent","summary":"Draft bounded counteroffers without exceeding an approved mandate.","mode":"reply","keywords":["offer","counter","price","terms","deadline"]}
