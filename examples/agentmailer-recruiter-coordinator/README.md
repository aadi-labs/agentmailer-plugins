...
Coordinate candidate interviews and next-step communication.
...
```sh
pnpm --filter @agentmailer/example-recruiter-coordinator start
```

## Python

```sh
cd examples/agentmailer-recruiter-coordinator/python
