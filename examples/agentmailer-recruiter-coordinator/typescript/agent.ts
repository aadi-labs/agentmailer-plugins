...
const CONFIG: { slug: string; title: string; summary: string; mode: string; keywords: string[] } = {"slug":"recruiter-coordinator","title":"Recruiter coordinator","summary":"Coordinate candidate interviews and next-step communication.","mode":"reply","keywords":["candidate","interviewer","availability","timezone","stage"]};
